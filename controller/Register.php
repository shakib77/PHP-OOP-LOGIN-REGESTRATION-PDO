  ...
  class Register extends Controller {
    ...
    **/
    ...
    public function register(array $data)
    {
      ...
      if (preg_match('/01[3456789][0-9]{8}\b/', $phone)) {
        $Error['phone'] = 'Please, use a valid phone number.';
        return $Error;
      }

      if (strlen($password) < 7) {
        $Error['password'] = 'Please, use a stronger password, Password must be at least 6 letter.';
        return $Error;
      }
      ...
      unset($Data['password']); //unset (destroyed Data) password. Makes a whole lot of sense to get rid of any critical information...
